		...
		extensionPoints: {
			...
			getWidgetMenuItems: (widgets) => {
				return Promise.resolve({
					tooltip: 'HiPlace holder for more...',
					svgIcon: icon24,
					onClick: (widgets) => {
